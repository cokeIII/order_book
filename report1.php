...
where o.people_id = '$people_ids' and o.status = '0' and o.term = '$terms' and o.subject_id = '$subject_id' and o.subject_name = '$subject_name' group by o.subject_id_book,b.name_book,o.author_id,o.pub_id,o.price,o.qty_page order by o.select_no limit 3";
