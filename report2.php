...
where o.people_id = '$people_ids' and o.status = '1' and o.term = '$terms' and o.subject_id = '$subject_id' and o.subject_name = '$subject_name' group by o.subject_id_book,b.name_book,author_id,pub_id limit 3";
