...
where o.people_id = '$people_ids' and o.status = '1' and o.term = '$terms' and o.subject_id = '$subject_id' and o.subject_name = '$subject_name' group by o.subject_id_book,o.author_id,o.pub_id,b.name_book limit 3";
